...
function makeCategory(overrides: Partial<PlanCategory> & Pick<PlanCategory, 'id' | 'group_name' | 'category_name' | 'block'>): PlanCategory {
  return {
    plan_id: 1,
...
const planFixture: ActivePlanResponse = {
  ...
  blocks: {
    ...
    annual: [
      makeCategory({ id: 20, group_name: 'Yearly', category_name: 'Insurance', block: 'annual', planned_milliunits: 100000, annual_target_milliunits: 1200000, due_month: 6 }),
    ],
    one_time: [],
    stipends: [
...
describe('PlanningPage', () => {
  beforeEach(() => {
    ...
    window.localStorage.setItem('finclaide:selected-month', '2026-04')
  })
