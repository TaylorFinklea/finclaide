...
function pageOf(transactions: TransactionsPageResponse['transactions'], total: number, offset: number): TransactionsPageResponse {
...
describe('TransactionsPage', () => {
  ...
  it('filters by group and resets pagination offset', async () => {
    ...
    const groupTrigger = screen.getAllByRole('combobox')[0]
    await userEvent.click(groupTrigger)
    await userEvent.click(await screen.findByRole('option', { name: 'Bills' }))
